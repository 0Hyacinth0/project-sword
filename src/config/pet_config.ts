...
export const PET_TYPE_CONFIGS: Record<number, PetTypeConfig> = {
  1001: {
    petTypeId: 1001, name: '火灵使', element: 1, rarity: 3,
    baseHp: 80, baseAttack: 18, baseDefense: 8, baseSpeed: 14,
    description: '诞生于熔岩的灵使，擅长火属性术法攻击',
    evolveTo: 1004, evolveLevel: 15,
    skills: [
      { id: 1, name: '炎灵弹', type: 'active_attack', power: 120, cooldown: 2, learnLevel: 1, description: '发射炎灵造成120%攻击力的伤害' },
      { id: 2, name: '灼烧', type: 'passive', learnLevel: 5, description: '攻击时有15%概率附加灼烧效果' },
      { id: 3, name: '烈焰护体', type: 'active_support', cooldown: 3, learnLevel: 8, description: '3回合内减少20%受到的伤害' }
    ]
  },
  1002: {
    petTypeId: 1002, name: '灵风狼', element: 3, rarity: 2,
    baseHp: 55, baseAttack: 14, baseDefense: 5, baseSpeed: 20,
    description: '栖息在高原的迅捷灵兽，身法极快',
    skills: [
      { id: 4, name: '疾风爪', type: 'active_attack', power: 100, cooldown: 1, learnLevel: 1, description: '快速爪击造成100%攻击力的伤害' },
      { id: 5, name: '风行术', type: 'passive', learnLevel: 3, description: '速度提升10%' },
      { id: 12, name: '狂风斩', type: 'active_attack', power: 140, cooldown: 3, learnLevel: 10, description: '释放狂风造成140%攻击力的伤害' }
    ]
  },
  1003: {
    petTypeId: 1003, name: '冰魄凤', element: 2, rarity: 4,
    baseHp: 120, baseAttack: 28, baseDefense: 12, baseSpeed: 16,
    description: '传说中的冰属性神兽，拥有极寒之力',
    skills: [
      { id: 6, name: '冰魄风暴', type: 'active_attack', power: 150, cooldown: 3, learnLevel: 1, description: '召唤冰魄风暴造成150%攻击力的伤害' },
      { id: 7, name: '寒冰护体', type: 'active_support', cooldown: 4, learnLevel: 5, description: '4回合内提升30%防御力' },
      { id: 8, name: '冰心诀', type: 'passive', learnLevel: 8, description: '受到攻击时有20%概率冻结攻击者1回合' }
    ]
  },
  1004: {
    petTypeId: 1004, name: '九天火凤', element: 1, rarity: 4,
    baseHp: 160, baseAttack: 38, baseDefense: 16, baseSpeed: 18,
    description: '火灵使的进化形态，浴火重生的不死神鸟',
    skills: [
      { id: 9, name: '涅槃之焰', type: 'active_attack', power: 200, cooldown: 4, learnLevel: 0, description: '释放涅槃之焰造成200%攻击力的伤害' },
      { id: 10, name: '炎灵之心', type: 'passive', learnLevel: 0, description: '所有火属性技能伤害提升20%' },
      { id: 11, name: '浴火重生', type: 'active_support', cooldown: 5, learnLevel: 0, description: '复活并恢复30%气血（每场战斗限1次）' }
    ]
  },
  1005: {
    petTypeId: 1005, name: '岩甲兽', element: 4, rarity: 1,
    baseHp: 70, baseAttack: 10, baseDefense: 15, baseSpeed: 6,
    description: '生活在山洞中的岩石灵兽，防御力出众',
    skills: [
      { id: 13, name: '岩石撞击', type: 'active_attack', power: 80, cooldown: 1, learnLevel: 1, description: '用岩石撞击造成80%攻击力的伤害' },
      { id: 14, name: '石化', type: 'passive', learnLevel: 4, description: '防御力提升15%' }
    ]
  },
  1006: {
    petTypeId: 1006, name: '圣光灵使', element: 5, rarity: 3,
    baseHp: 65, baseAttack: 16, baseDefense: 10, baseSpeed: 15,
    description: '沐浴圣光的灵使，拥有治愈之力',
    skills: [
      { id: 15, name: '天光箭', type: 'active_attack', power: 110, cooldown: 2, learnLevel: 1, description: '射出天光箭造成110%攻击力的伤害' },
      { id: 16, name: '圣光回春', type: 'active_support', cooldown: 3, learnLevel: 6, description: '恢复主人20%最大气血' },
      { id: 17, name: '天光庇护', type: 'passive', learnLevel: 9, description: '被攻击时10%概率完全闪避' }
    ]
  },
  1007: {
    petTypeId: 1007, name: '影魅猫', element: 6, rarity: 2,
    baseHp: 45, baseAttack: 16, baseDefense: 6, baseSpeed: 22,
    description: '潜伏在黑暗中的敏捷灵兽，暴击率极高',
    skills: [
  ...
  1008: {
    petTypeId: 1008, name: '玄水龟', element: 2, rarity: 1,
    baseHp: 90, baseAttack: 8, baseDefense: 18, baseSpeed: 5,
    description: '温和的水属性灵兽，擅长防御和保护',
    skills: [
  ...
  1009: {
    petTypeId: 1009, name: '雷隼', element: 1, rarity: 3,
  ...
  1010: {
    petTypeId: 1010, name: '九霄雷神', element: 1, rarity: 4,
    baseHp: 100, baseAttack: 35, baseDefense: 12, baseSpeed: 28,
    description: '雷隼的进化形态，掌控雷电之力的天空霸主',
    skills: [
